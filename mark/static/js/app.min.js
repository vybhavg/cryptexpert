...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const searchInput = document.querySelector(".searchh__text");
    const searchIcon = document.querySelector(".searchh__helper");

    searchInput.addEventListener("focus", function () {
        searchForm.classList.add("focused");
        searchIcon.classList.remove("zmdi-search");
        searchIcon.classList.add("zmdi-arrow-left");
    });

    searchInput.addEventListener("blur", function () {
        if (searchInput.value.trim() === "") {
            searchForm.classList.remove("focused");
            searchIcon.classList.remove("zmdi-arrow-left");
            searchIcon.classList.add("zmdi-search");
        }
    });
});
